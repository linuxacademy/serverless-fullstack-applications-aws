...
aws s3 mv ./package.zip s3://cloudassessments-lab-files/aws/s3/dynamodb_console_practical/sls1_s2_lab3_dynamodb_console_practical_datalaoder.zip --acl public-read