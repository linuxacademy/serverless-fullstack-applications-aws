...
aws s3 mv ./package.zip s3://cloudassessments-lab-files/aws/s3/lambda_console_practical/sls2_s3_lab1_lambda_console_practical_datalaoder.zip --acl public-read